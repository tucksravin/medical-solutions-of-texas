...
<section class="bg-light pt-32 pb-48">
    <ContentWidth>
        ...
        <Accordian accordianProps={[
            {label:"Why does VOSB status give priority for winning VA and DoD contracts?", content:"In the 2016 Kingdomware Techs., Inc. v. United States case, the Supreme Court unanimously affirmed the Rule of Two provision of a 2006 federal law. The Rule of Two mandates that VA contracts shall be set aside for veteran-owned small businesses if at least two such businesses exist that can perform the work at a reasonable price. This results in a wide swath of contracts set aside specifically for veteran-owned businesses, ones that VOSBs, like MSOT, have priority in winning."},
            {label:"What does our typical timeline look like after winning a contract?", content:"The timeline for this process begins with a Medical Manufacturer getting approval on the ECAT. Typically in the span of 30 to 90 days. The next critical step is ensuring compliance and readiness for the rollout phase. Once approved, the rollout to military bases and VA facilities takes place within a concise period of seven days, making the product accessible where it is most needed. Following the initial product deployment, the process transitions into a phase med-surge equipment can be provided, ensuring smooth operations and ongoing support. Finally, the timeline extends into a phase of ongoing contract maintenance, which is carried out as needed to uphold quality and reliability throughout the duration of the agreement."} 
        ]} />
    </ContentWidth>
